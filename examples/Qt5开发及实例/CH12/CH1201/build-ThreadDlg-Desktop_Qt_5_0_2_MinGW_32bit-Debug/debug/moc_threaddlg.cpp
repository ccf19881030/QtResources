...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ThreadDlg_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 21, 8)
    ...
    "ThreadDlg\0slotStart\0\0slotStop\0"
};
...
const QMetaObject ThreadDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ThreadDlg.data,
      qt_meta_data_ThreadDlg,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ThreadDlg.stringdata))
