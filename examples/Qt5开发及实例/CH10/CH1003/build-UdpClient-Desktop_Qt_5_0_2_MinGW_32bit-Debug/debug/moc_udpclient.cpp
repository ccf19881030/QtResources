...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_UdpClient_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 27, 12)
    ...
    "UdpClient\0CloseBtnClicked\0\0dataReceived\0"
};
...
const QMetaObject UdpClient::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_UdpClient.data,
      qt_meta_data_UdpClient,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UdpClient.stringdata))
