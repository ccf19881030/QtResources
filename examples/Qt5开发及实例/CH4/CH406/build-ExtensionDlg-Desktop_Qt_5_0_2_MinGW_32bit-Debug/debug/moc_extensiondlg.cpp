...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ExtensionDlg_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 28, 0)
    ...
    "ExtensionDlg\0showDetailInfo\0\0"
};
...
const QMetaObject ExtensionDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ExtensionDlg.data,
      qt_meta_data_ExtensionDlg,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ExtensionDlg.stringdata))
