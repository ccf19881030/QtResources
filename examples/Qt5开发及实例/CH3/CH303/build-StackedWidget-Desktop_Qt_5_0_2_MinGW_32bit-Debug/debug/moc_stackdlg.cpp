...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StackDlg_t, stringdata) + ofs \
...
const QMetaObject StackDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_StackDlg.data,
      qt_meta_data_StackDlg,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StackDlg.stringdata))
