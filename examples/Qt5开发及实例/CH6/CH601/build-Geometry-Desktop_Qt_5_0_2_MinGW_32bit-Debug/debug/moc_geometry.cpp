...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Geometry_t, stringdata) + ofs \
...
const QMetaObject Geometry::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Geometry.data,
      qt_meta_data_Geometry,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Geometry.stringdata))
